...
function updateLyricPreview() {
    ...
    const color =
        document.getElementById("lyricColor").value
...
function selectFormat(format) {
    ...
    document
        .getElementById("format-youtube")
        .classList.remove("active")

    document
        .getElementById("format-tiktok")
        .classList.remove("active")

    document
        .getElementById("format-square")
        .classList.remove("active")

    document
        .getElementById("format-" + format)
...
async function generate() {
    ...
    try {
        ...
        if (!audio || !bg) {
            ...
            alert(
                "Please upload both an MP3 and a background image first."
            )
